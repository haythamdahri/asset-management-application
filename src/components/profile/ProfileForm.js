  ...
  const onSubmit = async (data) => {
    ...
    if (data.updatePassword) {
      if (!data.password) {
        ...
        data?.password &&
        (passwordPattern.test(data?.password) === false ||
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="p-3 mb-5">
        ...
        <div className="form-group row">
          <label className="col-md-3 font-weight-bold" htmlFor="password">
            Mot de passe:{" "}
            {!user?.hasOwnProperty("id") && <b className="text-danger">*</b>}{" "}
          </label>
          <div className="col-md-9">
            <input
              disabled={saving}
              ...
              onChange={(e) => {
                ...
                // Check pattern
                if (passwordPattern.test(value) === false || value.length < 9) {
                  setError("password", {
                    type: "pattern",
                    message: "Mot de passe faible!",
                  });
            ...
            {errors.password && (
              <div className="invalid-feedback">
                {errors.password.type === "pattern" ? (
                  <>
                    Mot de passe faible, veuillez respecter le format suivant:{" "}
                    <br />
                    - Lettres miniscules <br />
                    - Lettres majiscules <br />
                    - Chiffres <br />
                    - Caractère spéciaux <br />- Avoir une longueur minimale de
                    9 charactères <br />
                  </>
                ) : (
        ...
        {/** TITLE */}
        <div className="form-group row">
          <label className="col-md-3 font-weight-bold" htmlFor="employeeNumber">
