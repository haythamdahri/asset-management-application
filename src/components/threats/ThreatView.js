      ...
      <section className="content">
        <div className="container-fluid">
          <div className="row">
            ...
            {(error || isUnAuthorized || threatResponse === null) && !isLoading && (
            ...
            {!isLoading && !error && !isUnAuthorized && threatResponse !== null && (
              <>
                {/** THREAT DATA */}
                    ...
                    <table className="table table-striped">
                      ...
                      <tbody align="center">
                        <tr>
                          ...
                          <td>
                            {threatResponse?.threat?.description &&
                              threatResponse?.threat?.description?.length > 0 && (
                                <CKEditor
                        ...
                        <tr>
                          ...
                          <td><Link to={`/typologies/view/${threatResponse?.typologyId}`}>{threatResponse?.typologyName}</Link></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
